...
extern int raydium_read_touchdata(struct raydium_ts_data *data,
	unsigned char *tp_status,  unsigned char *buf);
extern void raydium_mem_table_setting(unsigned short u16_id);
...
extern unsigned char i2c_burst_write(struct i2c_client *client,
				     int i32_addr,
...
extern int raydium_fw_update_check(struct raydium_ts_data *ts,
			unsigned short u16_i2c_data);
extern int raydium_i2c_pda_set_address(struct raydium_ts_data *ts,
...
extern unsigned char g_u8_table_setting;
