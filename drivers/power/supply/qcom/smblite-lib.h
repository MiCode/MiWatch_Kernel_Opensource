...
#define CAPACITY30_VOLTAGE	4000000
#define CAPACITY25_VOLTAGE	3750000
#define SOC_DIFFERENCE      1
#define SOC0_THRESHOLD		3410000
#define CUTOFF_VOLTAGE		3500000
enum smb_mode {
	PARALLEL_MASTER = 0,
	PARALLEL_SLAVE,
	NUM_MODES,
...
int smblite_lib_get_prop_is_demo_mode(struct smb_charger *chg,
				int *is_demo_mode);
